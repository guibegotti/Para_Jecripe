...
public class RWScript : MonoBehaviour {
	...
	public void YesNoChoice (Item i, UnityAction yesEvent)
	{
		...
		{
			buyQuestion.text = "Você confirma a compra do item " + ItemButton.sD.storeObjects[i.x].name+" por "+ItemButton.sD.storeObjects[i.x].price+" moedas?";
		...
		{
			buyQuestion.text = "Você não tem quantidade suficiente de moedas. Jogue mais vezes.";
