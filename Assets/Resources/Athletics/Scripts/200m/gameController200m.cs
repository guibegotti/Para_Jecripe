...
public class gameController200m : MonoBehaviour {

	private StoreDataContainer sD;
	private EnemyBehaviour200m adversaryScript, adversary2Script, adversary3Script;
	...
	void Start () {	
		...
		adversaryScript = GameObject.Find ("adversary").GetComponent<EnemyBehaviour200m>();
		adversary2Script = GameObject.Find ("adversary2").GetComponent<EnemyBehaviour200m>();
		adversary3Script = GameObject.Find ("adversary3").GetComponent<EnemyBehaviour200m>();
		end = false;
	...
	void scoreBuilder(){
		...
		terezinhaBehaviour_200m.bonusnumber += prizecoins;
	...
	void sortedTimes(){
		...
		time3 = terezinhaBehaviour_200m.playertime;
