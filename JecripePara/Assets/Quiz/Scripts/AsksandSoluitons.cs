...
public class AsksandSoluitons: MonoBehaviour{
	...
	void Start(){
		...
		QuizAsk [7] = "Os Jogos Paraolímpicos de Londres, que deveriam se tornar o palco da consagração do sul-africano Oscar Pistorius, serviram para que um brasileiro, em particular, mostrasse ao mundo o seu cartão de visitas. Sobre Pistorius, é possível afirmar que o atleta:";
		...
		QuizAsk [37] = "A partir dos seus conhecimentos sobre José Carlos Morais, é possível afirmar que:";
		QuizAsk [38] = "É crescente participação de pessoas com deficiência nas modalidades e competições, mas:";
		QuizAsk [39] = "De acordo com as normas, se a pessoa tiver total ou substancial perda funcional de uma ou mais partes extremas do corpo e for incapaz de participar de competições de tênis convencionais:";
		...
		SolA [21] = "Inclui plataformas de largada opcionais, largada de dentro da piscina ou o uso de sinais(“tapper”) para atletas com deficiência auditiva.";
		...
		SolA [27] = "Atletas com perda parcial dos movimentos das pernas competem junto com deficientes visuais e auditivos.";
		...
		SolA [35] = "Tokio";
		SolA [36] = "Passar nas avaliações muscular, de coordenação e funcional.";
		SolA [37] = "1976";
		SolA [38] = "Ele conheceu o esporte em 1985, na Inglaterra, quando competia com a seleção de basquete em cadeira de rodas.";
		SolA [39] = "E deslocando-se na quadra sem a velocidade adequada, estará credenciada para participar dos torneios de tênis para cadeirantes.";
		...
		SolB [7] = "É um nadador brasileiro, campeão olímpico dos 50 metros livre nos Jogos Olímpicos de Pequim em 2008";
		SolB [8] = "Federação Mundial de Veteranos.";
		SolB [9] = "Brasileiro";
		//Athletics
		SolB [10] = "Desde as Olimpíadas de Roma em 1960.";
		SolB [11] = "Londres.";
		SolB [12] = "O atleta troca de lugar com o guia no meio da competição, numa espécie de revezamento, por isso os guias começaram a subir no pódio junto com os atletas.";
		...
		SolB [21] = "Não inclui plataformas de largada opcionais, largada de dentro da piscina nem o uso de sinais(“tapper”) para atletas com deficiência visual.";
		...
		SolB [27] = "Atletas com problemas de coordenação severos nos quatro membros competem apenas com atletas com perda parcial dos movimentos das pernas .";
		...
		SolB [36] = "1978";
		SolB [37] = "Foi aos Jogos Paralímpicos de Guadalajara e, ao lado de Francisco Reis Junior, se tornou o primeiro brasileiro a representar o país na modalidade.";
		SolB [38] = "Número de praticantes ainda é inexpressivo se comparado à população que possui algum tipo de deficiência física.";
		SolB [39] = "Mesmo deslocando-se na quadra com velocidade adequada, não estará credenciada para participar nem dos torneios de tênis para cadeirantes.";
		...
		SolC [7] = "É o primeiro atleta olímpico e paralímpico da história a competir de maneira simultânea e em igualdade de possibilidades com atletas não deficientes em nível mundial e olímpico.";
		SolC [8] = "Comitê Olímpico Internacional.";
		SolC [9] = "Alemão.";
		//Athletics
		SolC [10] = "Desde os Jogos Panamericanos em 2011.";
		SolC [11] = "Berlin.";
		SolC [12] = "Os atletas são puxados pelos guias durante toda a competição.";
		...
		SolC [21] = "Inclui plataformas de largada opcionais, largada de dentro da piscina mas não o uso o uso de sinais(“tapper”) para atletas com deficiência auditiva.";
		...
		SolC [27] = "Tudo é muito bem divido de acordo com o grau de deficiência para que não haja vantagem ou desvantagem entre os atletas.";
		...
		SolC [36] = "1980";
		SolC [37] = "Ele conheceu o esporte em 1985, nos Estados Unidos, quando competia com a seleção de basquete em cadeira de rodas.";
		SolC [38] = "Os treinos preparatórios para o esporte ainda são muito caros para a maior parte da população.";
		SolC [39] = "Mas deslocando-se na quadra com velocidade adequada, estará credenciada para participar dos torneios de tênis para cadeirantes.";
		...
		SolD [18] = "Londres.";
		SolD [19] = "Nenhuma das anteriores.";
		//Swimming
		SolD [20] = "Raso, peito, borboleta, medley";
		SolD [21] = "Inclui plataformas de largada opcionais, largada de dentro da piscina ou o uso de sinais(“tapper”) para atletas com deficiência visual. ";
		SolD [22] = "Próteses ou aparelhos de assistência são permitidos apenas nas Paralimpíadas.";
		SolD [23] = "Roma, Itália";
		SolD [24] = "Nenhuma das anteriores.";
		...
		SolD [29] = "Nenhuma das anteriores.";
		//Tennis
		SolD [30] = "Italiana";
		...
		SolD [36] = "1982";
		SolD [37] = "Foi aos Jogos Paralímpicos de Atlanta e, ao lado de Francisco Reis Junior, se tornou o segundo brasileiro a representar o país na modalidade.";
		SolD [38] = "Nenhuma das anteriores.";
		SolD [39] = "Nenhuma das anteriores.";
		...
		CorrectSol [7] = "É o primeiro atleta olímpico e paralímpico da história a competir de maneira simultânea e em igualdade de possibilidades com atletas não deficientes em nível mundial e olímpico.";
		...
		CorrectSol [12] = "O atleta é direcionado para onde deve ir ou se deve acelerar ou não.";
		...
		CorrectSol [21] = "Inclui plataformas de largada opcionais, largada de dentro da piscina ou o uso de sinais(“tapper”) para atletas com deficiência visual. ";
		...
		CorrectSol [27] = "Tudo é muito bem divido de acordo com o grau de deficiência para que não haja vantagem ou desvantagem entre os atletas.";
		...
		CorrectSol [36] = "1980";
		CorrectSol [37] = "Ele conheceu o esporte em 1985, na Inglaterra, quando competia com a seleção de basquete em cadeira de rodas.";
		...
		CorrectSol [39] = "Mas deslocando-se na quadra com velocidade adequada, estará credenciada para participar dos torneios de tênis para cadeirantes.";
